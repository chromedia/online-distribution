  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <fieldset>
      <table class="form">
        ...
        <tr>
          <td>Password:</td>
          <td><input type="text" name="db_password" autocomplete="off" value="<?php echo $db_password; ?>" /></td>
        </tr>
    ...
    <fieldset>
      <table class="form">
        ...
        <tr>
          ...
          <td><input type="text" name="password" autocomplete="off" value="<?php echo $password; ?>" />
            <br />
