...
class ModelCatalogProduct extends Model {
	...
	public function getFeaturedProducts($limit)
	{
		...
		$product_data = $this->cache->get('product.featured.' . (int)$this->config->get('config_language_id') . '.' . (int)$this->config->get('config_store_id') . '.' . $customer_group_id . '.' . (int)$limit);
		...
		if (!$product_data) { 
			...
			$this->cache->set('product.featured.' . (int)$this->config->get('config_language_id') . '.' . (int)$this->config->get('config_store_id'). '.' . $customer_group_id . '.' . (int)$limit, $product_data);
		}
