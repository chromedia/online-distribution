...
class ModelCheckoutOrder extends Model {
	...
	// Custom method
	public function saveOrder($data, $order_status_id = 0, $comment = '', $notify = false)
	{
