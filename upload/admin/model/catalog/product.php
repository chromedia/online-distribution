...
class ModelCatalogProduct extends Model {
	...
	*/
	...
	public function addProduct($data) {
		// Set Product ID as model number 
		$product_id = $this->db->escape($data['model']);
		...
		foreach ($data['product_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_description SET product_id = '" . (int)$product_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', description = '" . $this->db->escape($value['description']) .  "', details = '" . $this->db->escape($value['details']) .  "', documentation = '" . $this->db->escape($value['documentation']) . "', tag = '" . $this->db->escape($value['tag']) . "'");
		}
	...
	public function getProduct($product_id) {
		...
		$sql = "SELECT DISTINCT *, (SELECT keyword FROM ";
			$sql .= DB_PREFIX . "url_alias WHERE query = 'product_id=" . (int)$product_id . "') AS keyword FROM ";
			$sql .= DB_PREFIX . "product p LEFT JOIN ";
			$sql .= DB_PREFIX . "product_description pd ON (p.product_id = pd.product_id) WHERE p.product_id = '" . (int)$product_id;
	...
	public function getProducts($data = array()) {
		...
		// Join product table and product_description table
